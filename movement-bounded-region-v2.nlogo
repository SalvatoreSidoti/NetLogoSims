...
to setup
  clear-all
  resize-world -120 120 -120 120 ; 1 unit = 1 mm
...
to move-turtles
  ask turtles [
    ...
    let d random-normal 10 4
    if [pcolor] of patch-ahead d = black [
    ...
    if
      ...
      and [pcolor] of patch-ahead d = gray ; our target patch is grey
